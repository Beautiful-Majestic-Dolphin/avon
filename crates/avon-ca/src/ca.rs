...
impl CertificateAuthority {
    ...
    fn generate_intermediate_certificate(
        ...
        let intermediate_signature = intermediate_keypair
            .sign(Domain::Cert, &cert_der)
            .map_err(|e| CaError::SigningFailed(e.to_string()))?;
        let root_signature = root_keypair
            .sign(Domain::Cert, &cert_der)
            .map_err(|e| CaError::SigningFailed(e.to_string()))?;
    ...
    pub async fn issue_ephemeral_cert(
        ...
        let hybrid_signature = self
            .intermediate_keypair
            .sign(Domain::Cert, &tbs_data)
            .map_err(|e| CaError::SigningFailed(e.to_string()))?;
